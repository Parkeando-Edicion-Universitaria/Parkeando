...
/**
 * Alert box con severity variants para info, éxito, warning, y error states.
 * Props - `variante` | `title` | `children` | `showIcon` | `showBorder` | `style`
...
/** trazo grosor para todas alert SVG icons (SVG user units). */
...
function createAlertStyles(theme: PdfxTheme) {
  ...
  return {
    ...
    /** Colores hex resueltos por variante, usados para teñir íconos SVG. */
    variantColors,
  };
}
