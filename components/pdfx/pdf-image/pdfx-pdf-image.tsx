...
/** Método HTTP usado al obtener la imagen desde una URL. */
...
/**
 * Image element con diseño presets, caption, y aspect ratio soporte.
 * Props - `src` | `variante` | `grosor` | `altura` | `fit` | `posición` | `caption` | `aspectRatio` | `borderRadius` | `noWrap` | `style`
