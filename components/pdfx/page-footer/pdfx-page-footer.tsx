...
/**
 * Footer fila con diseño variants, optional sticky or fija positioning, y contact info soporte.
 * Props - `leftText` | `rightText` | `centerText` | `variante` | `fondo` | `textColor` | `marginTop` | `address` | `phone` | `email` | `website` | `fija` | `sticky` | `pagePadding` | `noWrap` | `style`
...
export function PageFooter({
  ...
  // sticky implica fija; marginTop es irrelevante con posicionamiento absoluto
